...
const CreateRequisitionForm = (props) => {
    const { onSubmit, disableCheck, userList, unitsList, materialsList, departmentsList, productionsList } = props;
    ...
    const handleRowRemove = (indexToRemove) => {
        const updatedItems = formik.values.requisition_items.filter((_, index) => index !== indexToRemove);
        formik.setFieldValue('requisition_items', updatedItems);
    };
            ...
            <div className="p-6.5">
                <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                    <div className="w-full xl:w-full">
                        <FormField type="select" label="Production" id="production" options={productionsList} formik={formik} disabled={disableCheck} />
                    </div>
                </div>
