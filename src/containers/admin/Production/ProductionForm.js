...
const ProductionForm = (props) => {
	const { initialValues, onSubmit, disableCheck, userList, unitsList, productsList, productionPlantsList } = props;
			...
			<div className="p-6.5">
				...
				<div className="mt-15">
					<div className="flex justify-between items-center py-4 px-6.5">
						<h4 className="text-title-md2 font-semibold text-black dark:text-white">Production Items</h4>
